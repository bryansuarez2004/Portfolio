...
const Header = () => {
  return (
   <>
    ...
    <div className='h-[600px] relative overflow-hidden customShadow'>
      <div className='absolute flex justify-start p-5 sm:p-20 items-center w-screen h-full top-0 left-0 bg-transparent customShadow z-20'>
             ...
             <h1 className='font-main text-6xl sm:text-[120px] font-extrabold'>Hola! soy Bryan</h1>
             <p  className='font-main text-5xl sm:text-6xl bordeTexto font-bold text-cyan-300 '>Desarrollador Full Stack</p>
             </div>
